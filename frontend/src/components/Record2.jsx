        ...
        <div>
            <div className="container">
                <div className="card-body container shadow p-4 mb-3" style={{ color: "#47525E", display: "flex" }}>
                    <img alt="" src={Raster} style={{ width: "90px", height:"90px", marginTop:"10px", }} />
                ...
                <div className="card-body container shadow p-4 mb-3" style={{ color: "#47525E", display: "flex" }}>
                    ...
                    <img alt="" src={Train} style={{ width: "90px", height:"90px", marginTop:"10px", marginLeft: "40px" }} className="float-right" />
                </div>
                <div className="card-body container shadow p-4 mb-3" style={{ color: "#47525E", display: "flex" }}>
                    <img alt="" src={Bycicle} style={{ width: "90px", height:"90px", marginTop:"10px", }} />
                    <div style={{ textAlign: "right" }} className="col clearfix">
                ...
                <div className="card-body container shadow p-4 mb-3" style={{ color: "#47525E", display: "flex" }}>
                    ...
                    <img alt="" src={Green} style={{ width: "90px", height:"90px", marginTop:"10px", marginLeft: "40px" }} className="float-right" />
                </div>
                <div className="card-body container shadow p-4 mb-3" style={{ color: "#47525E", display: "flex" }}>
                    <img alt="" src={Location} style={{ width: "90px", height:"90px", marginTop:"10px", }} />
                    <div style={{ textAlign: "right" }} className="col clearfix">
                ...
                <div className="card-body container shadow p-4 mb-3" style={{ color: "#47525E", display: "flex" }}>
                    ...
                    <img alt="" src={Mountain} style={{ width: "90px", height:"90px", marginTop:"10px", marginLeft: "40px" }} className="float-right" />
                </div>
                <div className="card-body container shadow p-4 mb-3" style={{ color: "#47525E", display: "flex"}}>
                    <img alt="" src={Icecream} style={{ width: "90px", height:"90px", marginTop:"10px", marginBottom:"70px"  }} />
                    <div style={{ textAlign: "right"}} className="col clearfix">
