                    ...
                    <form>
                        ...
                        <div className="container" style={{ display: "inline-block" }}>
                            <div className="mx-auto" style={{ width: "200px" }}>
                                ...
                                <button type="button1" className="btn btn-dark btn-sm float-left" style={{ display: "flex" }} data-toggle="modal" data-target="#exampleModal"><img src={Facebook_logo} alt="Logo" className="rounded mx-auto d-block" width="25px" />
                                    Facebook
                                </button>
                            </div>
                        </div>
