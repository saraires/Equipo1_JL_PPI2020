...
export default function Inicio_sesion() {
    return (
        <>
            <div className="container" style={{ display: "inline-block", padding:"40px"}}>
                ...
                <form>
                    ...
                    <card className="center">
                        <div className="container" style={{ display: "inline-block", padding:"40px"}}>
                            ...
                            <div className="float-left" style={{ display: "float-left", padding:"10px"}}>
                                <select className="custom-select" size="7">
                            ...
                            <div className="float-left" style={{ display: "flex-left", padding:"10px"}}>
                                <select className="custom-select" size="7">
